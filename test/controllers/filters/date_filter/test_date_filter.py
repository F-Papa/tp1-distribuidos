...
def test_category_filter_works_if_no_faults():
    ...
    msg_body = {
        ...
        "conn_id": conn_id,
        "data": [
            {"title": "test1", "year": 2004, "categories": ["fiction"], "authors": ["peter"], "publisher": "test_pub"},
            {"title": "test2", "year": 1991, "categories": ["fiction"], "authors": ["peter"], "publisher": "test_pub"},
            {"title": "test3", "year": 2020, "categories": ["fiction"], "authors": ["peter"], "publisher": "test_pub"},
            {"title": "test4", "year": 2000, "categories": ["fiction"], "authors": ["peter"], "publisher": "test_pub"},
        ],
        "EOF": True,
    }
...
def test_category_filter_works_if_no_faults_multiple_messages():
    ...
    msg_body_2 = {
        ...
        "conn_id": conn_id,
        "data": [
            {"title": "test5", "year": 2006, "categories": ["fiction"], "authors": ["peter"], "publisher": "test_pub"},
        ],
        "EOF": True,
    }
...
def test_category_filter_works_if_no_faults_multiple_messages_and_connections():
    ...
    msg_body_2_conn_1 = {
        ...
        "conn_id": conn_id_1,
        "data": [
            {"title": "test6", "year": 2006, "categories": ["fiction"], "authors": ["peter"], "publisher": "test_pub"},
        ],
        "EOF": True,
    }
    ...
    data_1_q3_4_conn_1 = messaging.get_msgs_from_queue(output_queue_q3_4_prefix + str(conn_id_1))
...
def test_category_filter_recovers_from_crash():
    controller_id = "date_filter_test"
    file_path = f"./test/state_{controller_id}.json"
    temp_file_path = f"./test/state_{controller_id}.tmp"
    filter_number = 67
